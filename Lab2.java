public class Lab2 {
	...
	if (manGoingToStIves) {
	    ...
	    total = 2;
		total = total + (numWives);
		total = total + (numWives*numSacksPerWife);
		total = total + (numWives*numSacksPerWife*numCatsPerSack);
		total = total + (numWives*numSacksPerWife*numCatsPerSack*numKitsPerCat);
